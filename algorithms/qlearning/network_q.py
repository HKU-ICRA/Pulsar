...
class Network(tf.keras.Model):
    ...
    def __init__(self, batch_size=1, n_agents=1):
        ...
        self.update_eps = tf.Variable(initial_value=-1.0, name="update_eps", trainable=False)
    ...
    def call(self, obs, stochastic=True):
        q = self.get_q_value(obs)
