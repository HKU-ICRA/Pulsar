...
from environment.worldgen.transforms import set_geom_attr_transform
from environment.module.module import EnvModule

DEFAULT_INNER_WALLS_HEIGHT = 0.6
...
class Wall:
    ...
    '''
    def __init__(self, pt1, pt2, height=DEFAULT_INNER_WALLS_HEIGHT, rgba=(1, 1, 1, 1)):
...
def outside_walls(grid_size, rgba=(0, 1, 0, 0.1), use_low_wall_height=False):
    height = DEFAULT_INNER_WALLS_HEIGHT if use_low_wall_height else 4.0
